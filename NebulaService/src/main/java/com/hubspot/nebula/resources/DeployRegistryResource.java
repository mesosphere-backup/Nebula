...
@Path("/deploys/registry")
@Produces(MediaType.APPLICATION_JSON)
@Consumes({MediaType.APPLICATION_JSON})
public class DeployRegistryResource {
  private final DeployRegistryDAO dao;
  private final GitHubClient gitHubClient;

  @Inject
  public DeployRegistryResource(DeployRegistryDAO dao, GitHubClient gitHubClient) {
    this.dao = dao;
